<div class="ml-auto d-inline-flex">
    <li class="nav-item dropdown">
        <a class="nav-link  dropdown-toggle pt-1" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-save"></i> {{trans('adm_theme::lang.export')}}
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link pt-1" id="refreshDatatable" href="#"><i class="fa fa-refresh"></i> {{trans('adm_theme::lang.refresh')}}</a>
    </li>
    <li class="nav-item">
        <a class="nav-link pt-1" id="printDatatable" href="#"><i class="fa fa-print"></i> {{trans('adm_theme::lang.print')}}</a>
    </li>
    <li class="nav-item">
        <a class="nav-link pt-1" id="resetDatatable" href="#"><i class="fa fa-undo"></i> {{trans('adm_theme::lang.reset')}}</a>
    </li>
    <li id="colVisDatatable" class="nav-item dropdown keepopen">
        <a class="nav-link dropdown-toggle pt-1" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-eye"></i> {{trans('adm_theme::lang.columns')}}
        </a>
        <div class="dropdown-menu">
        ...
        {{--<div style="min-width: 200px;" id="filter" class="ml-auto pb-2 mx-2">--}}
            {{--<select name="collection_name" id="selectFilter" multiple="true" data-closeOnSelect="false" class="form-control-sm form-control select2">--}}
                {{--@foreach($filtered as $key => $item)--}}
                    {{--<optgroup label="{{trans('adm_theme::lang.glass_'.$key)}}">--}}
