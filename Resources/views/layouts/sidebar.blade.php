    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                {{--
                    @include('adm_theme::layouts.menu',['icons'=>true])
                --}}
                @include('adm_theme::layouts.partials.sidebar.menu',['icons'=>true])
                @include('adm_theme::layouts.partials.sidebar.models',['icons'=>true])
            </ul>
        </nav>
        <!-- /.sidebar-menu -->
    </div>
