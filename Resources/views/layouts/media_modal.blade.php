    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header align-items-stretch">
                <h5 class="modal-title flex-grow-1">{!! trans('adm_theme::lang.media_title') !!}</h5>
            ...
            <div class="modal-footer">
                <span>{!! trans('adm_theme::lang.media_hint') !!}</span>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{!! trans('adm_theme::lang.close') !!}</button>
            </div>
        </div>
    </div>
</div>
